...
export const CreatePost =()=>{
  ...
  const { loading:detailLoading,success:detailSuccess,error:detailError,post:detailPost } = postDetail
    ...
    // console.log('content')
    // setTitle(detailPost.title || title) 
    // setContent(detailPost.content || content)
    // setPostImage(detailPost.postImage || postImage)
    // setBlogState(detailPost.blogState || blogState)
    useEffect(()=>{
