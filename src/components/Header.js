...
export const Header = () => {
  ...
  return (
    <header className="header bg-white  flex items-center justify-center fixed w-full z-20 px-3 py-[1.5rem]">
        <nav className="h-[80%] w-[90%]  flex justify-between items-center  ">
            <Link to="/" className='text-[2rem] text-[#8034eb] font-[500] italic w-[10%]'>Blog</Link>
            <form className='w-[30%] flex items-center  h-[50%] border-2 border-[#8034eb] rounded-md'>
            ...
            <div className='w-[7%] h-[50%] flex items-center justify-between'>
                <button className="h-full"><FaFacebookF  className=' w-6 h-6 fill-[#8034eb]'/></button>
                <button className="h-full"><FaTwitter className='w-6 h-6 fill-[#8034eb]' /></button>
                <button className="h-full"><FaInstagram className='w-6 h-6 fill-[#8034eb]'/></button>
                <button className="h-full"><FaLinkedinIn className='w-6 h-6 fill-[#8034eb]'/></button>
            </div>   
            <div className='w-[5%]'>
               <button>
