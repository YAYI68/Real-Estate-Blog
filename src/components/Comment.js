  ...
  return (
    <div className='mx-auto my-[2rem] dark:bg-slate-800 bg-white p-5 flex flex-col'>
              ...
              <div className='flex justify-between w-full'>  
                 ...
                 {userInfo ?   
                 <button   className="h-14 w-14 flex items-center justify-center rounded-full hover:bg-slate-200 cursor-pointer "><FaTrashAlt className='fill-[red] md:h-5 md:w-5 h-7 w-7'/></button>
                :""
                }
              </div>
     </div>
